...
func channelReceiveSelectInternal() {
...

	{
		...
		select {
		case errChanSend <- <-errChan: // want "^error received from errChan is not wrapped with stacked$"
		}
	}
